...
Location.create!(
  ...
  audio: Cloudinary::Utils.cloudinary_url("https://res.cloudinary.com/dq9oebltp/video/upload/v1680181323/1_Joined_by_Happy_Scribe_wzozpp.wav", {resource_type: "video"}),
...
Location.create!(
  name: 'test',
  address: 'Altamura, SP41, 70022 Altamura BA, Italy',
  latitude: 40.75069185336932,
  longitude: 16.646276648928584,
)
